...
class Model(nn.Module):
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[core.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(core.engine.results.Results): The prediction results.
    """
    ...
    def predict(self, source=None, stream=False, predictor=None, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('core')) and any(
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        Returns:
            (List[core.engine.results.Results]): The tracking results.
        """
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        """
        Runs hyperparameter tuning, optionally using Ray Tune. See core.utils.tuner.run_ray_tune for Args.
