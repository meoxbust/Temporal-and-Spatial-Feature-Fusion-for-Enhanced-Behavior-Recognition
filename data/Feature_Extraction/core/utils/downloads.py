...
GITHUB_ASSETS_REPO = 'core/assets'
...
def delete_dsstore(path, files_to_delete=('.DS_Store', '__MACOSX')):
    ...
    Example:
        ```python
        from core.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=('.DS_Store', '__MACOSX'), progress=True):
    ...
    Example:
        ```python
        from core.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=('.DS_Store', '__MACOSX'), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from core.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from core.utils.downloads import get_google_drive_file_info
...
def get_github_assets(repo='core/assets', version='latest', retry=False):
...
def attempt_download_asset(file, repo='core/assets', release='v0.0.0'):
    """
