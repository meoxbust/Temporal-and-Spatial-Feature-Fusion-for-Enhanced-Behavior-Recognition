...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date core
            'default.yaml' file.\nPlease update your code with 'pip install -U core' and if necessary replace
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from core.utils import ThreadingLocked
        ...
        with torch_distributed_zero_first(RANK):
            ...
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    ...
                    'with your settings or a recent core package update. '
...
def deprecation_warn(arg, new_arg, version=None):
    ...
    LOGGER.warning(f"WARNING ⚠️ '{arg}' is deprecated and will be removed in 'core {version}' in the future. "
